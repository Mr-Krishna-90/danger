# A tool by Krishna from https://t.me/+GrRkWxyiROs4ZGU1
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn Krishna $red◀$rset"
echo -e "$red                      ⫸$ylo  Krishna Hackers$red ⫷$rset"
echo 
# Functions
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] Danger Infect"
...
then
am start -a android.intent.action.VIEW -d https://t.me/+GrRkWxyiROs4ZGU1 > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://GitHub.com/Mr-Krishna-90  > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mKrishna " | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mDARK LEADER" | pv -qL 10
...
echo -e "\e[93m        Telegram Channel:\e[92m https://t.me/+GrRkWxyiROs4ZGU1\e[0m" | pv -qL 10
...
while git clone https://github.com/Mr-Krishna-90/danger 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://t.me/+GrRkWxyiROs4ZGU1 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
